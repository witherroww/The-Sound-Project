      ...
      >
        ...
        <div className="p-6 bg-parchment">
          ...
          <div className="mt-4 flex gap-6">
            <div>
              <p className="font-mono text-xs text-obsidian/30">LAeq (mean)</p>
              <p className="font-mono text-xl text-amber">36.3 dB</p>
            </div>
            <div>
        ...
        >
          ...
          <div className="mt-4 flex gap-6">
            <div>
              <p className="font-mono text-xs text-obsidian/30">LAeq (mean)</p>
              <p className="font-mono text-xl text-slate">36.3 dB</p>
            </div>
            <div>
              <p className="font-mono text-xs text-obsidian/30">LCpeak</p>
